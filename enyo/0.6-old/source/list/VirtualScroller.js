...
enyo.kind({
	...
	tools: [
		{name: "drag", kind: "Drag"},
		{name: "scroll", kind: "ScrollMath", kFrictionDamping: 0.97, interval: 20, topBoundary: 1e9, bottomBoundary: -1e9}
	],
	chrome: [
	...
	measure: function(viewNode, contentNode) {
		...
		this.contentHeight = this.$.content.hasNode().offsetHeight;
		//this.rightBoundary = viewNode.clientWidth - contentNode.offsetWidth;
	},
	//* @public
	//
	...
	scroll: function() {
		...
		//this.log(this.pageTop);
		//this.effectScroll();
		//console.log(900 - this.pageTop, this.node.scrollTop);
		this.doScroll();
	},
