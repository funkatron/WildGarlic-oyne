...
enyo.kind({
	...
	components: [
		{kind:"enyo.SwipeableItem", layoutKind: "HFlexLayout", confirmRequired:false, onConfirm: "dbSwiped", components: [ 
			...
			{name: 'layer2', kind: "enyo.DashboardLayer", className: 'layer-2', onclick:"msgTapHandler", onSwipe:"layerSwiped"}
		]}
	],
	events: {
		onIconTap: "",
	...
	create: function() {
		...
		enyo.windowReactivatedHandler = enyo.bind(this, "handleNewLayers");
...
enyo.kind({
	...
	components:[
			{name:'swipeable', kind: "enyo.SwipeableItem", onDrag: "configureClipping", onConfirm:"doSwipe", 
	...
	configureClipping: function(inSender, dx) {
		if (this.clipControl && dx >= 0) {
			this.clipControl.setStyle("width:"+(dx+10)+"px;");
		}
	},
