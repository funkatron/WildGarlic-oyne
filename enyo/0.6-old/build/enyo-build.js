...
getContent: function() {
var a = "";
for (var b = 0, c; c = this.$.client.generateRow(b); b++) a += c;
return a;
},
...
create: function() {
this.inherited(arguments), this.$.view.setUrl(this.url), this.$.view.setMinFontSize(this.minFontSize), this.$.view.setAutoFit(this.autoFit), this.$.view.setFitRender(this.fitRender), this.$.view.setZoom(this.zoom), this.$.view.setEnableJavascript(this.enableJavascript), this.$.view.setBlockPopups(this.blockPopups), this.$.view.setAcceptCookies(this.acceptCookies);
},
activate: function() {
this.$.view.activate();
},
