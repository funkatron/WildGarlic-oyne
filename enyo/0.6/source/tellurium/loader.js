...
Tellurium.setup = function(inEnyo) {
	...
	var moreConfig = Tellurium.enyo.xhr.request({url: Tellurium.enyo.path.rewrite("$enyo/tellurium/tellurium_config.json"), sync: true}).responseText || "{}";
	Tellurium.config = Tellurium.extend(Tellurium.config, enyo.json.from(moreConfig));
