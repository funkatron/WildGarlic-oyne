...
enyo.script(enyo.path.rewrite("$enyo/base/core/resources/" + (a.lang || "en") + "/datetime.js"));
}
...
}, enyo.job._jobs = {}, enyo.time = function(a) {
...
}, enyo.time.timers = {}, enyo.time.timed = {}, enyo.dom = {
...
var d = a.search(new RegExp(b, "i"));
if (d < 0) return a;
var e = b.length, f = a.slice(0, d), g = a.slice(d, d + e), h = a.slice(d + e);
return f + '<span class="' + c + '">' + g + "</span>" + h;
}
...
var f = (new Date).getTime(), i = f - a;
a = f, d += i, e.push(i), ++c == 20 && (c--, d -= e.shift()), this.fps = (c * 1e3 / d).toFixed(1) + " fps", this.dragging && (this.y0 = this.y = this.uy, this.x0 = this.x = this.ux), b += i;
...
kind: enyo.Control,
published: {
src: "$enyo/base/controls/images/blank.gif"
},
nodeTag: "img",
create: function() {
...
filterDelay: 200,
create: function() {
this.inherited(arguments), this.disabledChanged(), this.inputTypeChanged(), this.valueChanged(), this.hintChanged(), this.inputClassNameChanged(), this.applySmartTextOptions();
},
destroy: function() {
this.stopChangeDelayJob(), this.inherited(arguments);
},
...
this.changeOnKeypress && (this.value = a.getValue(), this.keypressChangeDelay ? enyo.job(this.id + "-changeDelay", enyo.bind(this, "doChange", b, this.value), Number(this.keypressChangeDelay)) : this.doChange(b, this.value));
},
...
this.inherited(arguments), this.isEmpty() && this.updatePlaceholder(!this.hasFocus());
},
updatePlaceholder: function(a) {
...
showingChanged: function() {
this.inherited(arguments), this.scrim && (this.showing ? (this._scrimZ = this.findZIndex() - 1, enyo.scrim.showAtZIndex(this._scrimZ)) : enyo.scrim.hideAtZIndex(this._scrimZ), enyo.call(enyo.scrim, "addRemoveClass", [ this.scrimClassName, this.showing ]));
},
toggleOpen: function() {
...
_open: function() {
this.generated || this.render(), this._zIndex = ++enyo.Popup.count * 2 + this.findZIndex() + 1, this.applyStyle("z-index", this._zIndex), this.show();
},
openAt: function(a) {
...
close: function(a, b) {
this.isOpen = !1, this.dispatcher.release(this, !this.modal), this._close(), this.doClose(a, b);
},
_close: function() {
...
a.name = enyo.windows.makeUniqueWindowName(a, a.name), this.assignWindowParams(a, b), this.manager.addWindow(a);
},
makeUniqueWindowName: function(a, b) {
var c = this.getWindows(), d = c[b];
if (!this.agent.isValidWindowName(b) || d && d != a) {
var e = "window";
for (var f = 1, g; Boolean(c[g = e + (f > 1 ? String(f) : "")]); f++) ;
return g;
}
return b;
},
...
var f = this.makeAbsoluteUrl(window, b), g = d && enyo.isString(d) ? d : enyo.json.stringify(d), g = "attributes=" + g, h = e ? e + ", " : "";
...
indexPath: "$enyo/system/dashboard.html",
create: function() {
...
this.smallIcon && (b.icon = this.smallIcon), this.window = enyo.windows.openDashboard(enyo.path.rewrite(this.indexPath), this.name, a, b);
} else enyo.windows.activate(this.name, undefined, a);
} else this.window && (this.window.close(), this.window = undefined);
},
...
this.$.layer2.setLayer(b[2]), this.$.layer1.setLayer(b[1]), this.$.layer0.setLayer(b[0]), this.setIcon(b[b.length - 1].icon), this.$.layer1.setSwipeable(!b[2]), this.$.topSwipeable.setSwipeable(!b[1]), a > 1 ? (this.$.count.setContent(a), this.$.badge.show()) : this.$.badge.hide();
...
this.clipControl && this.clipControl.setStyle("width:" + Math.max(0, b + this.leftOffset) + "px;");
},
layerChanged: function() {
this.layer ? (this.show(), this.$.title.setContent(this.layer.title), this.$.text.setContent(this.layer.text), this.leftOffset && this.$.swipeable.setStyle("width:" + (270 - this.leftOffset) + "px;"), this.configureClipping(this, 0)) : (this.hide(), this.configureClipping(this, 270));
},
...
disabledChanged: function() {
this.$.labelOn.addRemoveClass("enyo-disabled", this.disabled), this.$.labelOff.addRemoveClass("enyo-disabled", this.disabled);
},
clickHandler: function() {
this.disabled || (this.setState(!this.getState()), this.doChange(this.state));
}
});
...
rendered: function() {
this.inherited(arguments), this.hasNode() && (this.transitionEndHandler = enyo.bind(this, "webkitTransitionEndHandler"), this.node.addEventListener("webkitTransitionEnd", this.transitionEndHandler, !1), this.log(this.frameworkClick), this.frameworkClick && (this.singleTapHandler = enyo.bind(this, "singletapHandler"), this.node.addEventListener("singletap", this.singleTapHandler, !1), this.domAttributes["enyo-pass-events"] = !1), this.node.eventListener = this, this.history = [], this.callQueue = [], this.lastUrl = "", this._viewInited = !1, this.initView());
},
hasView: function() {
...
this.cacheBoxSize(), this.minZoom = this.calcMinZoom(), this.setZoom(b * this.zoom), this.clearHistory();
if (!this.fitRender) {
...
singletapHandler: function(a) {
var b = enyo.dom.fetchNodeOffset(this.node);
this.callBrowserAdapter("clickAt", [ a.centerX - b.offsetLeft, a.centerY - b.offsetTop, 1 ]);
},
...
this.accelerated ? this.smartZoomAreaFoundAccelerated(a, b, c, d, e, f, g) : this.smartZoomAreaFoundUnaccelerated(a, b, c, d, e, f, g);
},
smartZoomAreaFoundUnaccelerated: function(a, b, c, d, e, f, g) {
var h = this._boxSize.w / (c - a), i = h / this.zoom, j, k = this.fetchScrollPosition();
h == this.zoom ? (h = this.fetchDefaultZoom(), j = 0) : j = a * h;
var l = f * h - this._boxSize.h / 2;
l < 0 && (l = 0), this.$.animator.setDuration(200), this.$.animator.setTick(15);
var m = 200 / 15;
this._f = {
zoom: h
}, this._c = {
...
zoom: (h - this._c.zoom) / m,
left: (j - this._c.left) / m,
top: (l - this._c.top) / m
}, this.callBrowserAdapter("enableFastScaling", [ !0 ]), this.$.animator.play(0, m);
},
stepAnimation: function(a, b) {
...
this.setZoom(this._f.zoom), this.callBrowserAdapter("enableFastScaling", [ !1 ]);
},
smartZoomAreaFoundAccelerated: function(a, b, c, d, e, f, g) {
var h = this._boxSize.w / (c - a), i;
h == this.zoom ? (h = this.fetchDefaultZoom(), i = 0) : i = a * h;
var j = f * h - this._boxSize.h / 2;
j < 0 && (j = 0);
var k = e, l = f, m, n = this.fetchScrollPosition();
h == this.zoom ? m = -n.l : m = i - n.l;
var o = j - n.t, p = h / this.zoom, q = (p - 1) * k - m, r = (p - 1) * l - o;
this.callBrowserAdapter("enableFastScaling", [ !0 ]), this.addClass("enyo-webview-animate"), this.applyStyle("-webkit-transform-origin", k + "px " + l + "px");
var s = "matrix3d(";
s += p + ",0,0,0,", s += "0," + p + ",0,0,", s += "0,0," + p + ",0,", s += q + "," + r + ",0,1)", this.node.style.webkitTransform = s, this._smartZoomInfo = {
zoom: h,
zoomChanged: h != this.zoom,
left: i,
top: j,
scrollChanged: i != n.l || j != n.t
};
},
webkitTransitionEndHandler: function() {
this.removeClass("enyo-webview-animate"), this.applyStyle("-webkit-transform-origin", null);
var a = enyo.dom.fetchNodeOffset(this.node), b = this.fetchScrollPosition(), c = this._smartZoomInfo;
this.callBrowserAdapter("skipPaintHack", [ c.zoomChanged, c.scrollChanged, -c.left + a.offsetLeft + b.l, -c.top + a.offsetTop + b.t ]), this.setScrollPosition(c.left, c.top), this.setZoom(c.zoom), this.callBrowserAdapter("enableFastScaling", [ !1 ]);
},
...
this.log(), this.setScrollPosition(0, 0);
},
...
if (this.frameworkClick) return !0;
...
create: function() {
this.inherited(arguments), this.identifierChanged(), this.urlChanged(), this.minFontSizeChanged(), this.autoFitChanged(), this.fitRenderChanged(), this.enableJavascriptChanged(), this.blockPopupsChanged(), this.acceptCookiesChanged(), this.acceleratedChanged(), this.frameworkClickChanged();
},
...
this.log(this.frameworkClick), this.$.view.setFrameworkClick(this.frameworkClick);
},
activate: function() {
...
srcChanged: function() {
this.src && this.bufferImage.src == this.src ? this.imageLoaded() : this.src && (this.$.image.setSrc("$enyo/base/controls/images/blank.gif"), this.bufferImage.src = this.src);
},
...
resize: function() {
this.sizeControls("100%", "100%"), this._controlSize = enyo.fetchControlSize(this.$.client), this._controlSize[this.scrollH ? "w" : "h"] = this._controlSize[this.scrollH ? "w" : "h"] - 2 * this.revealAmount, this.sizeControls(this._controlSize.w + "px", this._controlSize.h + "px", !0), this.setIndex(this.index);
},
...
flickHandler: function(a, b) {
if (Math.abs(b.xVel) > Math.abs(b.yVel)) {
this.handleSwipe();
return !0;
}
},
...
window.clearInterval(this.exitIntervalId), this.exitIntervalId = undefined, this.resetPosition(), this.setSwipeable(!0);
}
});
...
create: function() {
this.inherited(arguments), this.layout = new enyo.VFlexLayout, this.contentChanged(), this.slideStateChanged(), this.edgeDraggingChanged(), this.minWidthChanged();
},
destroy: function() {
...
var a = this.getPreviousSibling();
while (a) a.slideState = "covered", a = a.getPreviousSibling();
var b = this;
...
b.validateSlide(), this.slideComplete(), this.resizeLastSibling();
},
...
var a = parseInt(this.domStyles.left), b = 0;
this.manager.hasNode() && (b += this.manager.node.offsetWidth);
return b - a;
},
...
for (var a = 0, b = 0, c = this.findSiblings(), d; d = c[a]; a++) {
if (d == this) return b;
d.hasNode() && (b -= d.node.offsetWidth);
}
},
_move: function(a) {
a != this._slide && (this.applyDynamicSlideMode(), this._slide = a, this.domStyles.display != "none" ? this.applySlideToNode(this._slide) : this.slideState != "hidden" && this._moveFromHidden(a));
var b = this.getNextSibling();
b && b.validateSlide();
},
applySlideToNode: function(a) {
if (this.hasNode()) {
var b = this.node.style, c = a == null ? "" : a + "px";
this.slideMode == "static" ? b.left = c : b.webkitTransform = c ? "translate3d(" + c + ",0,0)" : "";
}
},
_moveFromHidden: function(a) {
this.deAnimate(), this.show(), this._move(this.calcSlideHidden()), enyo.asyncMethod(this, function() {
this.reAnimate(), this._move(a || 0);
});
},
webkitTransitionEndHandler: function() {
this.slideComplete();
...
this.manager.dragging || (this.manager.deAnimate(), this.applyStaticSlideMode(), this.hasAdjustableWidth() && enyo.asyncMethod(this, "adjustWidth", this.calcSlide()));
},
deAnimate: function() {
...
this.applyDragSlideState(), this.manager.dragging = null, a ? (this.manager.deAnimate(), this.applyStaticSlideMode(), this.resizeLastSibling()) : this.manager.reAnimate(), enyo.call(this.manager, "processSlideEvent");
},
...
this.slideMode != "static" && this.applySlideMode("static");
},
applyDynamicSlideMode: function() {
this.slideMode != "dynamic" && this.applySlideMode("dynamic");
},
applySlideMode: function(a) {
for (var b = 0, c = this.findSiblings(), d; d = c[b]; b++) d.applySlideToNode(null), d.slideMode = a, d.applySlideToNode(d._slide);
}
});
...
validate: function() {
var a = this.slidings;
enyo.call(a[0], "validateAll"), enyo.call(a[a.length - 1], "slideComplete");
},
deAnimate: function() {
...
if (d) {
this.dragSliding = d, this.$.drag.start(b), this.dragSliding.beginDrag(b, 0);
return !0;
}
},
drag: function(a, b) {
...
this.$.dbPages.reset(b), a.flush(), a.top = b, a.bottom = b - 1, this.$.dbPages.require(b), this.$.dbPages.require(b + 1), this.needs = b + 1;
},
punt: function() {
...
className: "enyo-nouveau enyo-footer",
...
className: "enyo-header enyo-nouveau"
});

// themes/Gemstone/Button.js

enyo.kind({
name: "enyo.gemstone.Button",
kind: enyo.Button,
className: "enyo-gemstone enyo-button"
});

// themes/Gemstone/RoundedBox.js
...
kind: "HFlexBox",
align: "center",
className: "enyo-gemstone enyo-rounded-box-inner"
} ]
});

// themes/Gemstone/RoundedInput.js
...
// themes/Gemstone/SearchInput.js
...
components: [ {
kind: "Image",
src: "$enyo/themes/Gemstone/images/search-icon.png",
style: "display: block",
onclick: "fireSearch"
} ],
keypressHandler: function(a, b) {
...
// themes/Gemstone/RadioButton.js

enyo.kind({
name: "enyo.gemstone.RadioButton",
kind: enyo.RadioButton,
className: "enyo-gemstone enyo-radiobutton"
});

// themes/Gemstone/Popup.js

enyo.kind({
name: "enyo.gemstone.Popup",
kind: enyo.Popup,
className: "enyo-gemstone enyo-popup"
});

// themes/Gemstone/Header.js
...
flex: 1,
align: "center",
className: "enyo-gemstone enyo-header-inner"
} ]
}), enyo.gemstone.PageHeader = enyo.gemstone.Header;

// themes/Gemstone/Footer.js

enyo.kind({
name: "enyo.gemstone.Footer",
kind: enyo.Footer,
className: "enyo-gemstone enyo-footer",
defaultKind: "gemstone.MenuButton"
}), enyo.gemstone.CommandMenu = enyo.gemstone.Footer;

// themes/Gemstone/MenuButton.js

enyo.kind({
name: "enyo.gemstone.MenuButton",
kind: enyo.MenuButton,
className: "enyo-gemstone enyo-button enyo-menu-button-shape"
});

// themes/Gemstone/SwipeableItem.js

enyo.kind({
name: "enyo.gemstone.SwipeableItem",
kind: enyo.SwipeableItem,
className: "enyo-gemstone enyo-item"
});
